...
void loop(){
        ...
        /* End of Self Protection*/
            ...
            MOVE(Stadirection,StaSpeed,StaSpeed);
...
inlint void PWMMOVE(int direction,int Lduty,int Rduty){
    TowardsNow=direction;
    if(direction==STOP){
        digitalWrite(EN1,LOW);
        digitalWrite(EN2,LOW);
    ...
    ledcWrite(PWM_EN1_CH,Lduty);
    ledcWrite(PWM_EN2_CH,Rduty);
    
    return;
}
/* 

    To do After 20220424 23:30:

    Motor Run Correctly -> Finished at 2022/4/27 23:30
    Screen Show Emotion -> Finished at 2022/4/25 9:30
    Running Speed Detection -> Finished at 2022/4/27 13:30
    Running Speed PWM Adjustment -> Finished at 2022/4/30 11:00
    Running Speed Closed Loop Control -> need to Optimize MOVE() function
    Audio Output -> Waiting for PCB

    Extention:
    Light-detection-sensor  -> Finished at 2022/4/25 10:00
    Simple Remote Control -> Finished at 2022/4/26 16:00
